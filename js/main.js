...
$('.formphp').on('submit', function() {
	var emailContato = "maxsuelf94@gmail.com"; //Escrever o email 
	...
	$.ajax({
		...
		success: function(response) {
			...
			if($('[name="leaveblank"]').val().length != 0) {
				...
				$('#form-erro').html("<span>Falha no envio!</span><p>Você pode tentar novamente, ou enviar direto para " + emailContato + " </p>")
				.hide()
